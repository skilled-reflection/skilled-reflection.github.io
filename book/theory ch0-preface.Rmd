...
## Book to-dos
### from-WORDS  
These ideas are carrots
for the futre or another section  

1-
a theoretical optimum lies bx
gains in word revision
and time lost for action.

2-
Style without content
NORMS WORDS
have no reliable meaning;
Any validation or assurance is brittle. 
- Not "If I'm nice will you trust me?"  

3-NOTES  
When one part of a statement 
applies to more than one other part
nest the latter
...
An animal 
experiences (feels) the world, and
takes ACTIONS on it.

Humans
imagine (BET) 
changes to actions (PLAN) that 
improve experiences (GOAL).

Which PLANS lead to successful GOALS?
How, if at all, are BETS relevant?
Or differences in individuals, and context?

Answering these questions
also addresses the following:
How rational are human actions?
How strong are habit vs will?
How relevant are human network effects?
How real or imaginary are GOALS?

This book presents a model framework
meant to robustly codify
experience, action, and bets,
for the purpose of investigating
what it is people feel, do, and think;
with the ultimate goal of 
optimizing GOALS.

Intermediary goals include
- a model for all self-help
- a universal data structure for all psychological experiences
- a grounded and practical universal semantics
- a universal, quantifiable framework for hypothesis testing (and generating)
- a framework for refining thought and language,
  - (resilient to centrist biases)
  i-a smarter and more cooperative species
...
The bad consequence is that it could seem a mystery if / why something is suggested. Why did I ask you to write down the time?
Because all of your life, the good and the bad, are most simply knowable, understandable, manipulable, in terms of time. The more you know how your life, your meaning, etc., relate to time, the more you understand your life, and have a chance to do something about it.
In this case, you now have a rough estimate of when you started reading this book.
