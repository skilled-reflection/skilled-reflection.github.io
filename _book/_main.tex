...
\textbf{c2.38.} GOAL names an ideal future reality, comprises a PLAN to increase its likelihood, associated with CHUD.\\
\textbf{c2.44.} PLAN is WORDS that facilitate your GOAL (or decrease its COSTS).\\
\textbf{c2.49.} COST is materially required--muscle energy (actions), cash, brain power-- for GOALs.\\
\textbf{c2.56.} FOOD is the necessary and sufficient material to satisfy these needs.\\
\textbf{c2.57.} CAKE is anything (else) fulfilling, that you are inclined to pursue, including the reason for living.\\
\textbf{c2.58.} SELF is what's necessary and sufficient for FOOD and to maximize BET outcomes (\protect\hyperlink{bet}{c5.28}).\\
\textbf{c2.59.} HOME is the collection of materials and TOOLS, materials, money (which support HABITs).\\
...
\textbf{c4.13.} NORMS are all actions assumed of (or about) the ``average'' person, including WORK and CHUD.\\
\textbf{c4.16.} Language is PPLs' agreed usage (NORMs) of WORDS.\\
\textbf{c4.17.} NORMS push against individuality.\\
\textbf{c4.20.} A FORCE is any cause of change including actions toward GOALs and CHUD.\\
\textbf{c4.21.} MAINTENANCE is the COST of FORCE to neither move toward nor away from a GOAL.\\
\textbf{c4.22.} ALIGNMENT is shared FORCE for alternative GOALs which reduce COST.\\
\textbf{c4.23.} Relationships (RLTP) are GOALS about PPL (PPL).\\
\textbf{c5.23.} A BET is a PLAN template for reconciling REALITY with CHUD, to accomplish GOALS.\\
\textbf{c5.41.} CHUD encompasses the changes in you, the world, and your GOAL for you to achieve it.\\
\textbf{c5.43.} HABITS are your dominant tendencies (FORCES); reliable FOOD or CAKE actions.\\
\textbf{c5.44.} UNKNOWNS are the FORCEs (especially out of your CONTROL) that make your PLAN wrong.
\textbf{c5.48.} DOUBTS are predictable failures of estimating Reality, PLANs and UNKNOWNs.\\
\textbf{c6.15.} A STUDENT is a ROLE with IDEAS from EXPERIENCE toward selfish GOALS.\\
\textbf{c6.39.} A READER is a listener and observer ROLE.\\
...
\textbf{c8.19.} LESSONS are an ordered set of prompts, usually three to four, up to 60 minutes and 250 WORDS.\\
\textbf{c8.33.} NOTES are general PLANS for REVISION. (Available on request.)\\
\textbf{c8.37.} The RECIPE is a DOC format that PRIs CONTENT (IDEAS and LINKS) over STYLE.\\
\textbf{c8.45.} COMM is the exchange of WORDS between PPL.\\
\textbf{c8.48.} The problem of COMM is the difference in meaning between READER and WRITER of the same WORD.\\
...
\textbf{c9.58.} PPL are different VERSIONs of PRI (WRITER and READER of DOC are different, too).
