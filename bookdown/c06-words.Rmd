...
This will include healthier communication and relationships.
...
The benefit is when saying words or hearing and understanding a word prevents or improves actions you would've taken otherwise.
However, you likely spend an unnecessary part of your life on words that either don't help or leave you worse off.

## Bet  {#word-bet}

A word is a bet on the world. 
...
It caused you to name in the first place. this cause is "it". good-ref is giving the best name for our desired communication.
...
I want to hear what you were going to say. <!-- (communication-pri) -->
...
Does not add to communication-pri nor return to it. 3-'early' may not be true.
...
-   1: you or the other return to communication-pri without ever returning to this interruption. 
-   4: it reduces the number of words said before returning to communication-pri. 
...
5 is the communication-pri, and 4 is the cause, but not it in what you
...
In communication, examples are described per the criteria that might
