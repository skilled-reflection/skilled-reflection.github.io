...
\textbf{Note:} If you are reading this, you have an early copy of the 2nd version of
...
\item
  Please engage your life. This book is meant to help you break through mental
...
\item
  ...
  your life, right now.
\item
  Every WORD you say to yourself is at best a PLAN for action, meaningless until
  you take that action.
\item
  Consider every WORD I write a PLAN to improve your actions.
\item
  Reasons for the PLAN are always less important than consequences of following
  them, often omitted.
\item
  What is important will appear, and what isn't will be forgotten.
\end{enumerate}
...
\setcounter{enumi}{12}
\item
  This book presents seemingly obvious facts of life, and yet they are precisely what is essential to a deeper integration with yourself and between people.
\item
  The first way to see this is to consider going on a camping trip, right now.
\item
  Unless this is routine for you, you will likely over- or under-prepare. Most people will be 1-3 hours late.
\item
  Whether you're an experienced camper or not, this is your only shot at a lifelong camping trip for yourself on Earth, and my guess is you are very likely late to your own life.
\item
  This is the book to assure you that you're not forgetting something or over-thinking your ambitions.
\item
  Your primary challenge is to find and repair the disconnect between your mind's image of TIME, and the one you are physically bound to.
\item
  If you fail, you will die in two worlds, the world you imagine you could have
  lived, and the one you did.
\item
  You'll read this book carefully, because you would like to not only pass, but ace your own life.
\item
...
\item
  Part two teaches you how to take apart and rebuild your tools, to whatever standard of a perfect self you choose to pursue.
\item
  The first task to master will resolve most issues of mis-perceived time (c1.18): Be exact about what you need vs.~what you want.
\item
  Now, suppose you are hungry, and you must choose between finding FOOD or CAKE.
\item
  In this book, FOOD refers to needs and CAKE refers to wants.
\item
  You must practice this so much that you can instantaneously determine which part of your actions is FOOD and which is CAKE.
\item
  Then, no matter what you will need to plan or respond to, (however complicated the camping trip), you can trust you won't be late.
\item
  Because when you know what is FOOD and CAKE in a fluent and generative way, then planning and executing is a simple two step process:

  \begin{enumerate}
  \def\labelenumii{\arabic{enumii}.}
  \tightlist
  \item
    Get and prepare (pack) all FOOD.
  \item
    Get and prepare the best CAKE--that time allows.
  \end{enumerate}
\item
  Now, stop. Likely at this point you have slipped into thinking this is a book discussing a philosophy, but it is not.
\item
...
\item
  What's more, you can discover more room for CAKE when you are so far from your living room that you don't even know where it is, because you're homeless and you don't have one.
\end{enumerate}
...
\tightlist
\item
  The odds are you aren't and haven't been, and will very much avoid ever being homeless.
\item
  So consider any and all other surprising and scary experiences in your life.
  ...
  \end{enumerate}
\item
  In the first moments, there is shock and terror, frustration and suffering. Your
  habit protests for a change in PLANS.
\item
  However small or profound the suffering or its threat, if you endure for long enough, there will be a noticeable shift in your HABIT. What you call suffering will change.
\item
  The more you pay close attention to your desires and needs, you will find yourself needing far less FOOD than you originally thought, in order to get more of the quality CAKE you really desire.
\end{enumerate}
...
\item
  Use the ennumeration of ideas to cross-reference.
\item
  The item immediately above is ``c1.45''. ``c1'' referring to this chapter, and ``45'' to the item number.
\item
  This will be taken advantage of in future revisions.
\item
...
\item
  In this garden we'll consider all your biological needs -- eating, sleeping
...
\item
  (There will be no defecating on plants, or a defecation plant in this garden.)
\item
...
\item
  Everything that could be true or in your hand, but isn't right now, is a GOAL.
\item
  It is your GOAL if you aim to increase its probability.
\item
...
\item
  These actions are subgoals of maintaining SELF, the category of basic human
  GOALS.
\item
  FOOD is the necessary and sufficient material to satisfy these needs.
\item
  CAKE is anything (else) fulfilling, that you are inclined to pursue, including the
  reason for living.
\item
  The GOALS of SELF are what's necessary and sufficient to obtain and manage
...
\item
  ...
  \tightlist
  \item
    At its best, this limiting fact drastically improves the reality of PLANS and
    GOALS.
  \item
    At its worst, it is the most common oversight responsible for bloated
    CHUD.
  \item
...
\item
  When you get bored, ask yourself why attempting to understand and define
  yourself bores you.
\item
...
\item
  RLTPS, especially family members, coordinate many GOALS for
  SAVINGS.
\item
...
\item
  A stranger comes to your garden at the end of a long day, chopping his
  jaw. You look up.
\item
...
\item
  BET wins shorten your PLAN, and the distance to your GOAL. Losses
...
\hypertarget{back-to-the-garden}{%
\section{Back to the Garden}\label{back-to-the-garden}}
...
\item
  A train might stop you from arriving on TIME.
\item
  From a planning standpoint, it is unclear if you can control
  UNKNOWNs, but you can estimate them.
\item
  Failures to accurately estimate reveal DOUBTS.
\item
  DOUBTs are the difference (error) between your PLAN's estimate of
  reality, and Reality.
\item
...
\item
  ...
  theory.
\item
  For example, Freud's talk therapy was, in his TIME, the radical idea that WORDS
  could fix PPL.
\item
...
\item
  push-writer In order to do something about thoughts, we need to think on
...
\item
  Good writing is discovering, curating, and applying insight. Bad WRITING has an
  author; ad hominem
\item
...
\item
  WRITING for LIB-PPL, relatable, depersonalized, objective WORDS, minimizes
  ROT, maximizes PLAN utility.
  Instructor
\item
  I am instructor, a guardian of
  72.1. True IDEAs and
...
\item
  Every WORD itself is a BET on hypotheticals, which can be true (reality)
  or false (fantasy).
\item
...
\hypertarget{meanings-of-words}{%
\section{Meanings of Words}\label{meanings-of-words}}
...
\def\labelenumi{\arabic{enumi}.}
\item
  {[}50,51,56,57{]} The GOAL of WORDS is to express ideas of maximum
  CAKE tomorrow.
\item
  Since few WORDS meet these criteria, start by revising toward fewer
  WORDS.
\item
...
\item
  A WORD limit is a proxy for its complexity.
\item
...
\item
  For every PLAN you make: Assert a WORD limit before writing, to be
...
\item
  NOTES are general PLANS for REVISION. (Available on request.)
\item
...
\item
  COMM-PPL assumes READING and WRITING have no intrinsic GOALS.
\item
...
\item
  For example, a document that elaborates about trump would begin titled ``c4.23 v2.14'', giving the relevant chapter\_number.idea\_number in the version 2.14.
\item
  In that version of SR, 4 is the chapter PPL, and number 23 is the definition of RLTP. Trump, the article topic, is an example.
\item
...
\item
  That book, then optimized to maximize the most learning, determines its STYLE.
\end{enumerate}
...
\setcounter{enumi}{98}
\item
  below are the chapter and line numbers for IDEA definitions, alphabetical.
\item
  Okay you got me, that's a promise and this is a placeholder for a future version that fulfills the promise. Start the clock: 2022-03-09-2129
\end{enumerate}

\hypertarget{epilogue}{%
\chapter{Epilogue}\label{epilogue}}

\hypertarget{reader-opt-in}{%
\section{Reader Opt-in}\label{reader-opt-in}}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Now you have read this book.
\item
  What were your numbers? (6.50)
\item
  Annotate 100 lines you would bet 1 dollar on each, and you are an IBC student.
...
\hypertarget{prequel-to-answerword}{%
\section{Prequel to Answerword}\label{prequel-to-answerword}}

\texttt{comm-by-instructor0\ to-instructors}\strut \\
\texttt{i-"By\ the\ instructor\ of\ instructors,\ to\ instructors."}
...
\item
  You are a teacher when your student has paid for both your TIME.
\end{enumerate}

\hypertarget{beginnings}{%
\section{Beginnings}\label{beginnings}}
...
\tightlist
\item
  If you need more examples to make more sense of this book, read the second, ``Answerword''.
\item
  If you need to stand beyond the limits of both, prepare with the third and last book, ``Lastword''.
\end{enumerate}
