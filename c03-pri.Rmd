...
6. For example, sleep. About 4 hours daily is a  vital priority for everyone (FOOD), but sleeping in on the weekends is not (CAKE). 
...
35.	Attention.
    1.	At its best, this limiting fact drastically improves the reality of PLANS and 
GOALS. 
    2.	At its worst, it is the most common oversight responsible for bloated 
CHUD. 
    3.	GOAL importance (PRIS) partly depends on context.
    4.	Group GOALS by shared actions, places, or times. Make/group/keep, 
